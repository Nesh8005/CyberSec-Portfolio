...
while loop: iterate until a condition is no longer True.
...
print(i) → prints all IDs.

if i == 5100: → prints special message only at 5100.

## Conclusion
**What are your key takeaways from this lab?**

Loops let you automate repetitive tasks efficiently, such as checking IP addresses or generating employee IDs, while conditionals inside loops allow you to handle special cases or alerts without stopping the overall process. Using for is best when the number of iterations is known, and while is ideal when a condition controls the loop.    
